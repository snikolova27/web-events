    ...
    function submitComment() {
        ...
        xhr.onload = function() {
            ...
            if (xhr.status >= 200 && xhr.status < 300) {
                ...
                'commentsList'); // Assuming you have an element with this ID
    ...
    function submitResource() {
        ...
        xhr.onload = function() {
            ...
            if (xhr.status >= 200 && xhr.status < 300) {
                ...
                // Optionally, update the UI to show the new comment
                // This could be adding the new comment to a list of comments, for example
                var resourcesList = document.getElementById(
                'resourcesList'); // Assuming you have an element with this ID
